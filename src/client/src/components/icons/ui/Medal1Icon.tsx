...
export function Medal1Icon({ size, color = '#fbbf24', className, style, title }: IconProps) {
  ...
  return (
    ...
    >
      ...
      {/* Numero 1 */}
      <text x="12" y="18" textAnchor="middle" fontSize="7" fontWeight="bold" fill="white" opacity="0.9">1</text>
    </svg>
  );
}
